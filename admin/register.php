...
<!-- /fonts -->
<!-- css -->
<link href="./admin/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all" />
	...
	<div class="content-agile2">
		<form action="rg.php" method="post">
			...
			<div class="form-control w3layouts">	
				<input type="text" id="text" name="newuser" placeholder="" title="Please enter a valid user" required="">
			</div>

			<div class="form-control agileinfo">	
				<input type="password" class="lock" name="newpass" placeholder="Password" id="password1" required="">
			</div>	
