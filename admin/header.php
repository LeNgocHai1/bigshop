...
<head>
    ...
    <script type="text/javascript" src="./checkeditor/ckeditor/ckeditor.js"></script>
...
<body>
    ...
    <div id="user-nav" class="navbar navbar-inverse">
        <ul class="nav">
            ...
            <li class=""><a title="" href="authenticator.php"><i class="icon icon-cog"></i> <span class="text">Settings</span></a></li>
    ...
    <!--start-top-serch-->
    <div id="search">
	<form action="resultAdmin.php" method="get">
    ...
    <div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
        <ul>
            <li><a href="products.php"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
